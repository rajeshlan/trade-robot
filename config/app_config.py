...
logging.info(f"Bybit API Key 1: {BYBIT_API_KEY_1}")
logging.info(f"Bybit API Secret 1: {BYBIT_API_SECRET_1}")
logging.info(f"Bybit API Key 2: {BYBIT_API_KEY_2}")
logging.info(f"Bybit API Secret 2: {BYBIT_API_SECRET_2}")
logging.info(f"Twitter Bearer Token: {TWITTER_BEARER_TOKEN}")
